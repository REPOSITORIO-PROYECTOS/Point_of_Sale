/** AFIP fiscal helpers shared with the POS frontend (backend copy for runtime). */
...
export function validateCustomBuyer(
  buyer: Pick<AfipCheckoutBuyer, 'tipoDocumento' | 'documento' | 'idCondicionIva'>,
): string | null {
